...
public class SpreadsheetService {
    ...
    public HSSFWorkbook convertToSpreadsheet(TestSubmission submission,
        ...
        Cell r1c20 = row1_labels_derived.createCell(20);
        r1c20.setCellValue("Average time partial oblique trial");
        ...
        row2_data_derived.createCell(12).setCellFormula("L2/I2");
        ...
        row2_data_derived.createCell(16).setCellFormula("COUNTIF(raw_data!R4:raw_data!R17,\"CORRECT\")");
        ...
        row2_data_derived.createCell(20).setCellFormula("T2/Q2");
